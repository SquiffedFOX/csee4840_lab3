...
/////////////////////////////////////////////////////////////////////
         ...
         else if(packet.keyboard[0] == 22){//s
            if (prev_keystate[0] == '0' && prev_keystate[1] == '0')
            {
               // Do something here
               printf("Key %02x pressed\n",packet.keycode[0]);        
         ...
         else if(packet.keyboard[0] == 20){//q
            if (prev_keystate[0] == '0' && prev_keystate[1] == '0')
            {
               // Do something here
               printf("Key %02x pressed\n",packet.keycode[0]);        
         ...
         else if(packet.keyboard[0] == 44){//space
            if (prev_keystate[0] == '0' && prev_keystate[1] == '0')
            {
               // Do something here
               if (prepos.ot == 70){
